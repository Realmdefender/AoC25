...
def count_zero_points(rotations):
    dial_position = 50
    zero_count = 0
...
password = count_zero_points(rotations)
...
def count_all_zero_points(rotations):
    dial_position = 50
    zero_count = 0
    ...
    for rotation in rotations:
        ...
        if (dial_position == 0 and step == -1):
            zero_count -= 1
        
        
        dial_position = (dial_position + step * distance)
...
password_v2 = count_all_zero_points(rotations)
print(f"The password to open the door using method 0x434C49434B is: {password_v2}")